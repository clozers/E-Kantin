...
<div style="background-image:url('<?= BASE_ASSETS ?>/images/bg.jpg');margin:0px !important;">
  <div class="vh-100 d-flex justify-content-center align-items-center">
    <div class="col-md-4 p-5 shadow-sm border rounded-3">
      <h5 class="text-center mb-4 text-danger">E-Kantin</h5>
      <hr />
      <h4 class="text-center mb-4 text-danger">Login</h4>
      <?php
      if (isset($message)) {
      ...
      <form method="POST" action="<?= base_url("auth/login") ?>">
        <div class="mb-3">
          ...
          <input type="username" class="form-control border border-danger" name="identity" required>
        </div>
        <div class="mb-3">
